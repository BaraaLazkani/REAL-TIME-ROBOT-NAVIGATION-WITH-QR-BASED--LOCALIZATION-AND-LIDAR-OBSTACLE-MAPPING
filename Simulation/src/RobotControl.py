...
class RobotControl(object):
    ...
    def process_measurements(self):
        ...
        self.est_pose = self.kalman_filter.step_filter(self.vel[0], imu_meas, np.asarray(meas))
        print(self.est_pose[0],self.robot_sim.get_gt_pose()[0])
...
def main(args):
    ...
    param_path = 'D:\Capstone\Final_solution\params.yaml' # rospy.get_param("~param_path")
    f = open(param_path,'r')
    params_raw = f.read()
    f.close()
